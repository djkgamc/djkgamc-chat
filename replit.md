...
- **Model Strategy:** First response uses gpt-5-pro-2025-10-06, then switches to gpt-5.1 with medium reasoning for follow-up turns (store: false)
...
- **Deep Research Feature:** Added deep research toggle (flask icon, purple when active) that:
  - Calls OpenAI's o3-deep-research model for comprehensive research
